...
hidden_imports = [
    "batch_verification",
    "scripts.single_case_workflow",
    "src",
    "src.csv_exporter",
    "src.dicom_network",
    "src.dicom_processor",
    "src.dicom_secondary_capture",
    "src.patient_manager",
    "src.pipeline",
    "src.segmentator",
    "src.statistics",
...
hidden_imports += collect_submodules("pynetdicom")

a = Analysis(
    ["run_single_case_gui.py"],
...
coll = COLLECT(
    ...
    upx=True,
    upx_exclude=[],
    name="oppoCT-Single-Case-DICOM-Package",
)
